            ...
            ?>
                    <div class="card mt-4 ">
                        <div class="card header ">
                            <h4 class="text-center mt-3 text-uppercase font-weight-bold ">Edit Category
                                ...
                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <img src="uploads/<?= $data['image'] ?>" height="55px" width="55px">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea row="3" name="meta_keywords" placeholder="Enter meta keywords" class="form-control"><?= $data['meta_keywords'] ?>
                                    </textarea>
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary" name="update-category_btn">Update</button>
